    ...
    <script>
        ...
        function agregarPermiso(){
            ...
            if(nombre.length > 200){
                toastMensaje('error', 'Máximo 200 caracteres para Nombre')
                return;
            }
            ...
            if(descripcion.length > 200){
                toastMensaje('error', 'Máximo 200 caracteres para Descripción')
                return;
            }
            ...
            axios.post(url+'permisos/extra-nuevo', formData, {
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        ...
                        toastMensaje('success', 'Permiso agregado');
                        recargar();
                    }
                    else{
        ...
        function borrar(){
            ...
            axios.post(url+'permisos/extra-borrar', formData, {
                ...
                .then((response) => {
                    ...
                    if(response.data.success === 1){
                        toastMensaje('success', 'Permiso globalmente eliminado');
                        recargar();
                    }else{
